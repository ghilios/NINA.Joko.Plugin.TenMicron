...
namespace NINA.Joko.Plugin.TenMicron.SequenceItems {
    ...
    public class BuildGoldenSpiralModel : SequenceItem, IValidatable {
        ...
        public BuildGoldenSpiralModel(INighttimeCalculator nighttimeCalculator, ICameraMediator cameraMediator) : this(TenMicronPlugin.TenMicronOptions, TenMicronPlugin.MountMediator, TenMicronPlugin.MountModelBuilderMediator, TenMicronPlugin.ModelPointGenerator, nighttimeCalculator, cameraMediator) {
        }

        public BuildGoldenSpiralModel(ITenMicronOptions options, IMountMediator mountMediator, IMountModelBuilderMediator mountModelBuilderMediator, IModelPointGenerator modelPointGenerator, INighttimeCalculator nighttimeCalculator, ICameraMediator cameraMediator) {
